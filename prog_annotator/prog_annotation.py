...
def check_latest_session_log(log_path = "./prog_annotator/latest_session.log"):
    try:
...
def store_latest_session_log(file_name, log_path = "./prog_annotator/latest_session.log"):
    try:
