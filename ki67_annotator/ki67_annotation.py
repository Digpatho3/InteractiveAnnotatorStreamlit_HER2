...
def check_latest_session_log(log_path = "./ki67_annotator/latest_session.log"):
    try:
...
def store_latest_session_log(file_name, log_path = "./ki67_annotator/latest_session.log"):
    try:
